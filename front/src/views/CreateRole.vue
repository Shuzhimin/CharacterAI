<template>
  <div class="all">
    <div class="content" style="height: 100%">
      <el-container>
        <el-aside width="40%" style="position: relative">
          <el-progress type="circle" :percentage="percentage_compute" style="position: absolute;left: 50%;top: 50%;transform: translate(-50%, -50%);" :color="colors" />
        </el-aside>
        <el-main>
          <div>
            <el-form :model="createForm" label-position="top" style="max-width: 30%; ; ">
              ...
              <!--&lt;!&ndash;                                <el-input v-model="avatarDescription" :rows="4" type="textarea"&ndash;&gt;-->
              <!--&lt;!&ndash;                                          :autosize="{ minRows: 6, maxRows: 8 }"&ndash;&gt;-->
              <!--&lt;!&ndash;                                          placeholder="请输入头像的描述"></el-input>&ndash;&gt;-->
              <!--&lt;!&ndash;&lt;!&ndash;                                <span style="position: absolute; bottom: 10px; right: 10px; color: #999;">{{ avatarDescriptionLength }}/100</span>&ndash;&gt;&ndash;&gt;-->

              <!--                                <el-button @click="generateAvatar" class="generate-avatar-button">生成头像</el-button>-->
              <!--&lt;!&ndash;                                <el-image v-if="createForm.avatarUrl" :src="createForm.avatarUrl"&ndash;&gt;-->
              <!--&lt;!&ndash;                                          style="max-width: 150px; max-height: 150px;"></el-image>&ndash;&gt;-->

              <!--&lt;!&ndash;                                <el-button @click="saveAvatar" type="primary" class="enter-button">确定</el-button>&ndash;&gt;-->
              <!--                            </div>-->
              <!--                        </el-dialog>-->
...
export default {
  ...
  computed: {
    ...
    percentage_compute() {
      var res = 0;
      if (this.createForm.selectedCategory !== ''){
        res += 25;
      }
      if (this.createForm.bot_name !== ''){
        res += 25;
      }
      if (this.createForm.bot_info !== ''){
        res += 25;
      }
      if (this.createForm.avatar_url !== ''){
        res += 25;
      }
      return res;
...
.all {
  /*height: 100%;*/
  background: linear-gradient(to right, #F6F7F9, #ffffff, #F6F7F9);
}
